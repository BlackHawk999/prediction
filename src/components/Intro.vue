...
.intro {
  background-image: url("../assets/image/blik.png");
  ...
  &-img-wrapper {
    position: relative;
    background-image: url("@/assets/image/background-icon.svg");
